        ...
        <main className="flex-1 p-8 bg-white">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm min-h-[150px]">
              <h3 className="text-sm font-semibold text-gray-900">New leads (All Users)</h3>
            ...
            {/* Widget 2 */}
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm min-h-[150px]">
              <h3 className="text-sm font-semibold text-gray-900">Conversion Rate (Global)</h3>
              <div className="mt-4 flex items-baseline gap-2">
            ...
            {/* Widget 3 */}
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm min-h-[150px]">
              <h3 className="text-sm font-semibold text-gray-900">Total Pipeline (All Users)</h3>
              <div className="mt-4 flex items-baseline gap-2">

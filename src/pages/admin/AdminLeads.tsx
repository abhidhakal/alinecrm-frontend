    ...
    <div className="flex min-h-screen w-full bg-white">
      ...
      <div className={`flex flex-1 flex-col transition-all duration-300 ${isExpanded ? 'ml-[280px] max-w-[calc(100vw-280px)]' : 'ml-[110px] max-w-[calc(100vw-110px)]'}`}>
        ...
        <section className="px-8">
          <AdminViewBanner
            label="Viewing all leads across all users"
            stats={`${leads.length} Total Leads`}
          />
        </section>
        ...
        <main className="p-8 space-y-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-lg bg-gray-900 px-4 py-2.5 text-[16px] font-medium text-white hover:bg-gray-800 transition-colors"
            >

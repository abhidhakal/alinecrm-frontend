    ...
    <div className="flex min-h-screen w-full bg-white relative font-sans">
      ...
      <div className={`flex flex-1 flex-col transition-all duration-300 ${isExpanded ? 'ml-[280px] max-w-[calc(100vw-280px)]' : 'ml-[110px] max-w-[calc(100vw-110px)]'}`}>
        ...
        <div className="px-8 mt-4">
          <AdminViewBanner
            label="Viewing and managing group social presence"
          />
        </div>

        <main className="flex-1 p-6 lg:p-10 space-y-8 overflow-y-auto w-full pt-4">
          {/* Sub Header / Stats Overview */}
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 tracking-tight">Admin Social Hub</h2>
              <p className="text-sm font-medium text-gray-500">Oversee and coordinate social channels for the entire team.</p>
            </div>
          ...
          <div className="grid grid-cols-1 xl:grid-cols-12 gap-8">
                ...
                <div className="p-6">
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      placeholder="Post as the brand... syncs to team history immediately."
                      value={postContent}
                  ...
                  <div className="mt-6 flex items-center justify-between pt-6 border-t border-gray-50">
                    <div className="flex items-center gap-2 text-xs font-medium text-gray-400">
                      <AlertCircle size={14} />
                      <span>Admin activities are logged for auditing</span>
                    </div>
                    <button
                      onClick={handleBulkShare}
                      disabled={!postContent.trim() || selectedPlatforms.length === 0}
                      className="flex items-center gap-2 rounded-xl bg-foreground px-8 py-3.5 text-sm font-semibold text-white shadow-lg transition-all hover:bg-foreground/90 disabled:opacity-30 disabled:pointer-events-none active:scale-[0.98]"
                    >
                      <Share2 size={18} />
                      Launch Bulk Share
                    </button>
              ...
              <div className="bg-white rounded-[20px] border border-gray-100 shadow-sm overflow-hidden min-h-[400px]">
                <div className="px-6 py-5 border-b border-gray-50 flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-base font-semibold text-gray-900">Global Post History</h3>
                  </div>
                  <span className="text-[10px] font-medium text-gray-400">Master Feed</span>
                </div>
                ...
                <div className="divide-y divide-gray-50">
                  {isLoading ? (
                    <div className="flex flex-col items-center justify-center py-20 gap-4 text-gray-400">
                      ...
                      <p className="text-sm font-semibold">Fetching master logs...</p>
                    </div>
            ...
            <div className="xl:col-span-4 space-y-8">
              ...
              <div className="bg-white rounded-[20px] border border-gray-100 shadow-sm p-6 overflow-hidden">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-base font-semibold text-gray-900">Institution Channels</h3>
                  </div>
                ...
                <div className="space-y-4">
                  {channels.length === 0 ? (
                    <div className="text-center py-8">
                      <p className="text-xs font-medium text-gray-400 italic">No channels added.</p>
                      <button
                        onClick={() => setShowAddModal(true)}
              ...
              <div className="bg-foreground rounded-[20px] p-6 text-white overflow-hidden relative group">
                <div className="relative z-10">
                  <p className="text-[10px] font-semibold text-white/50 mb-2">Admin Control</p>
                  <h4 className="text-sm font-semibold mb-3">Shared Governance</h4>
                  <p className="text-xs font-medium text-white/70 leading-relaxed">
                    Channels added here are synchronized across all employees. Ensure credentials are kept secure within official platform hubs.
                  </p>
                </div>

      ...
      <div className="mt-auto flex flex-col gap-4 pt-6 pb-4">
        ...
        {isAdmin && (
          <div className="relative group">
            <Link to="/admin/dashboard" className={`group flex w-full items-center rounded-2xl bg-gradient-to-r from-purple-600 to-indigo-600 p-2 text-white shadow-lg shadow-purple-200 transition-all hover:from-purple-700 hover:to-indigo-700 hover:shadow-xl active:scale-[0.98] ${isExpanded ? 'gap-3' : 'justify-center'
              }`}>

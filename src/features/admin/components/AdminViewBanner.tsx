    ...
    <div className="mt-6 rounded-2xl border border-slate-200 bg-slate-50/50 p-4 transition-all hover:bg-slate-50">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h3 className="text-sm font-bold text-black leading-none mb-1">Administrator Control</h3>
            <p className="text-[11px] font-medium text-black uppercase tracking-widest">{label}</p>
          </div>
        </div>
        {stats && (
          <div className="flex items-center gap-3">
            <span className="text-[10px] font-bold text-black bg-white px-4 py-2 rounded-full border border-slate-200 uppercase tracking-widest shadow-sm">
              {stats}
            </span>
          </div>
        )}

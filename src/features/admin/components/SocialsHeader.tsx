...
export default function SocialsHeader({ onRefresh, lastUpdated = null }: SocialsHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex w-full items-center justify-between border-b border-gray-100 bg-white/95 backdrop-blur-sm px-8 pt-8 pb-4">
      ...
      <div className="flex items-center gap-4">
        <h1 className="text-2xl font-bold tracking-tight text-gray-900">Social Media</h1>
